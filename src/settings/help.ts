...
export function KeyBasedOnSettings(
	settings: GitHubPublisherSettings
): DocumentFragment {
	...
	explanation.createEl('ul', undefined, span => {
		span.createEl('li', undefined, span => {
			...
			span.createEl('ul', undefined, l => {
				l.createEl('span', {
					text: i18next.t('settings.help.frontmatter.share.other'),
				});
			});
		});
		span.createEl('li', undefined, span => {
		...
		span.createEl('ul', undefined, l => {
			...
			l.createEl('li', undefined, p => {
				...
				p.createEl('span', {
					text: `: ${i18next.t('settings.help.frontmatter.nonShared')}`,
				});
			});
		});
		...
		span.createEl('ul', undefined, l => {
			l.createEl('li', undefined, span => {
				...
				span.createEl('span', {
					text: `: ${i18next.t('settings.help.frontmatter.attachment.send')}`,
				});
			});
			l.createEl('li', undefined, p => {
				p.createEl('code', { text: 'folder' });
				p.createEl('span', {
					text: `: ${i18next.t('settings.help.frontmatter.attachment.folder')}`,
				});
			});
		});
		span.createEl('li', undefined, span => {
		...
		span.createEl('li', undefined, span => {
			...
			span.createEl('ul', undefined, ul => {
				...
				ul.createEl('li', undefined, li => {
					...
					li.createEl('span', {
						text: `: ${i18next.t('settings.help.frontmatter.repo.branch')}`,
					});
				});
				ul.createEl('li', undefined, li => {
